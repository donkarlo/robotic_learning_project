...
\section{Brain models}
    \subsection{Free energy}
        ...
        The most important \cite{friston-2010-the-free-energy-principle-a-unified-brain-theory}
            \includepdf[pages=-]{\figspath free-energy.pdf}
            
            \includegraphics[width=1\linewidth]{\figspath free_energy_diagram.png}
...
\section{Self-awareness}
    ...
    \includepdf[pages=-]{\figspath self_awareness.pdf}
